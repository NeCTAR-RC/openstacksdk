...
class TestLoadBalancer(base.BaseFunctionalTest):
    ...
    AVAILABILITY_ZONE_DATA = '{"compue_zone": "nova"}'
    ...
    def setUp(self):
        ...
        self.AVAILABILITY_ZONE_ID = test_az.id
    ...
    def tearDown(self):
        ...
        self.conn.load_balancer.delete_availability_zone(
            self.AVAILABILITY_ZONE_ID, ignore_missing=False)
    ...
    def test_availability_zone_find(self):
        ...
        self.assertEqual(self.AVAILABILITY_ZONE_ID, test_availability_zone.id)
    ...
    def test_availability_zone_update(self):
        self.conn.load_balancer.update_availability_zone(
            self.AVAILABILITY_ZONE_ID, name=self.UPDATE_NAME)
        test_availability_zone = self.conn.load_balancer.get_availability_zone(
            self.AVAILABILITY_ZONE_ID)
        self.assertEqual(self.UPDATE_NAME, test_availability_zone.name)

        self.conn.load_balancer.update_availability_zone(
            self.AVAILABILITY_ZONE_ID, name=self.AVAILABILITY_ZONE_NAME)
        test_availability_zone = self.conn.load_balancer.get_availability_zone(
            self.AVAILABILITY_ZONE_ID)
        self.assertEqual(self.AVAILABILITY_ZONE_NAME,
                         test_availability_zone.name)
